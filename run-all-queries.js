/**
 * CompetentNL Knowledge Graph Explorer
 * 
...
// Configuratie
const CONFIG = {
  endpoint: process.env.SPARQL_ENDPOINT || 'https://sparql.competentnl.nl',
...
async function main() {
  ...
  console.log(`API Key: ${CONFIG.apiKey ? '✓ Geconfigureerd' : '✗ Niet ingesteld'}`);
  ...
  console.log('');
  console.log('Stuur de bestanden exploration-results.json naar Claude voor analyse!');
}
